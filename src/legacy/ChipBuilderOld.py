...
import src.legacy.HangingResonatorOld as HangingResonator
...
class ChipBuilder:
    ...
    def __init__(self, chip_width=10000, chip_height=6000, width=10, gap=6, ground=50, hole=40):
        ...
        self.port_params = PortParams(160, 200, 300, 0, self.width, self.gap, self.ground, self.hole)
    ...
    def _write_structures(self, res_params):
        ...
        for res in res_params:
            ...
            x_prog += safe_zone/2
            if type(res) == HangingResonatorOldParams:
