...
class EndHooks(pya.PCellDeclarationHelper):
    ...
    def produce_impl(self):
        ...
        create_end_hooks(self, pya.DPoint(0, 0), 0, width, gap, ground, hole, self.hooks, end_gap, hook_width, hook_length, hook_unit)


# angle in degrees
def create_end_hooks(obj, start, rotation, width, gap, ground, hole, hooks, end_gap, hook_width, hook_length, hook_unit):
    g_list = []
    mask_list = []
    hole_list = []
