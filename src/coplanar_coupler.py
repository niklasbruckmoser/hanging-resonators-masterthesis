#!/usr/bin/python
# slightly modified class from https://github.com/ooovector/cpw_coupling
...
class coplanar_coupler:
    def __init__(self, s1=None,s2=None,w1=None,w2=None,w3=None,epsilon_eff=None):
        self.s1 = s1
        self.s2 = s2
        self.w1 = w1
        self.w2 = w2
    ...
    def coupling_matrices(self,mode='notch'):
        if mode=='notch':
        ...
        C_l = 2*C_dimensionless*epsilon_0*self.epsilon_eff
        L_l = L_dimensionless*mu_0/2
        coupling_matrix = L_dimensionless*mu_0/2/np.sqrt(epsilon_0*mu_0*self.epsilon_eff)
